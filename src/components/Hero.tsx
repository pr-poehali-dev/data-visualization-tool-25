  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center px-6 lg:px-12 pt-20">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center">
        ...
        >
          Зарабатывайте
          <span className="block text-sage">на ваших лидах</span>
        </h1>
        ...
        >
          15% от LTV каждого клиента. По договору, стабильно и прозрачно. Мы работаем с партнёрами уже 7 лет и ни разу не задержали выплату.
        </p>
