  ...
  return (
    <section ref={sectionRef} className="py-32 lg:py-40 px-6 lg:px-12 bg-sage">
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          Передал им двух клиентов на SEO — получил 180 тыс. рублей за первый год. Выплачивают
          точно в срок, всегда на связи. Лучший пассивный доход из тех, что у меня есть.
        </blockquote>
        ...
        >
          <p className="text-sm tracking-widest uppercase text-primary-foreground/80">Алексей Воронов</p>
          <p className="text-sm text-primary-foreground/60 mt-1">Партнёр, веб-студия «Формат»</p>
        </div>
      </div>
    </section>
  )
